...
sudo curl -o - -L https://snapshots.radiumblock.com/kusama_25416509_2024-10-20.tar.lz4 | lz4 -c -d - | sudo tar -x -C /home/$current_user/.local/share/polkadot/chains/ksmcc3/
