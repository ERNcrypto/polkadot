...
sudo curl -o - -L https://snapshots.radiumblock.com/kusama_25430586_2024-10-21.tar.lz4 | lz4 -c -d - | sudo tar -x -C /home/$current_user/.local/share/polkadot/chains/ksmcc3/
