...
sudo chmod -R 777 /home/$current_user/.local/share/polkadot/chains/ksmcc3/db/full && sudo chmod -R 777 /home/$current_user/polkadot-sdk && sudo chmod -R 777 /home/$current_user/polkadot-sdk/target/release/polkadot-execute-worker && sudo chmod -R 777 /home/$current_user/.local/share/polkadot/chains/ksmcc3
...
sudo curl -o - -L https://snapshots.radiumblock.com/kusama_25121734_2024-09-29.tar.lz4 | lz4 -c -d - | sudo tar -x -C /home/$current_user/.local/share/polkadot/chains/ksmcc3/
