...
read -p "Enter SNAP :" SNAP
echo 'export SNAP='$SNAP
...
sudo curl -o - -L https://snapshots.polkachu.com/snapshots/kusama/kusama_$SNAP.tar.lz4 | lz4 -c -d - | sudo tar -x -C /root/.local/share/polkadot/chains/ksmcc3/
